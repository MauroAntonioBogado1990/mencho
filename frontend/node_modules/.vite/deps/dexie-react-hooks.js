...
function useDocument(doc) {
	...
	var providerRef = import_react.useRef(null);
	var DexieYProvider = Dexie["DexieYProvider"];
	...
	} else if ((_b = providerRef.current) === null || _b === void 0 ? void 0 : _b.doc) providerRef.current = null;
	import_react.useEffect(function() {
		if (doc) {
			if (unregisterToken) fr.unregister(unregisterToken);
			if (DexieYProvider.for(doc)) return function() {
